		...
		<div class="row margin-top-100">	
			...
			<div class="col-md-6 col-sm-6 search-content panel-width-550px panel panel-default">
				...
				<div class="panel-body height-410px">
					<h2 class="quicksand text-bold size-16px">Introduktion</h2>
					<p class="text-normal quicksand">Vi är entusiatiska gamers som har valt att skapa en trevlig mötesplats på nätet för gamers.
					<a name="robert"></a>Här kan du utvexla dina efarenheter med andra gamers och prata om dina favoritspel. 
					Varmt välkommen!</p>
					<br>
					<!-- robert -->
					<ul class="media-list">
						<li class="media">
							<div class="media-left white-a-text">	
								...
								<br>
								<a href="mailto:robjen@gamerskeep.se" class="btn btn-sm btn-primary btn-block media-center text-center" role="button">
							...
							<div class="media-body">
								<h4 class="media-heading text-bold quicksand">
   								...
   								<p class="text-normal quicksand size-16px">
					...
					<ul class="media-list">
						<li class="media">
   							<div class="media-left white-a-text">	
								...
								<br>
								<a href="mailto:dorand@gamerskeep.se" class="btn btn-sm btn-primary btn-block media-center text-center" role="button">
							...
							<div class="media-body">
								...
								<p class="text-normal quicksand">
									...
									<br>
									Andra intressen: Fotografera, digital grafik,
					<a name="maria"></a> musik, springa.
					...
					<ul class="media-list">
  						<li class="media">
    						<div class="media-left white-a-text">	
								...
								<br>
								<a href="mailto:mardro@gamerskeep.se" class="btn btn-sm btn-primary btn-block media-center text-center" role="button">
									<span class="glyphicon glyphicon-envelope" aria-hidden="true" class="span-bottom"></span>&nbsp;Kontakt
								</a>
    						</div>
							...
							<div class="media-body">
								...
								<p class="text-normal quicksand size-16px">
									...
									<br>
									<br>
									Andra intressen: Design, fotografera,
									<a name="malena"></a>
									 cafébesök med vännerna samt springa.
								</p>
    						</div><!-- media body -->
  						</li><!-- media -->
					</ul><!-- media list -->					
					...
					<ul class="media-list">
  						<li class="media">
    						<div class="media-left white-a-text">	
								...
								<br>
								<a href="mailto:maljan@gamerskeep.se" class="btn btn-sm btn-primary btn-block media-center text-center" role="button">
									<span class="glyphicon glyphicon-envelope" aria-hidden="true" class="span-bottom"></span>&nbsp;Kontakt
								</a>
    						</div>
							...
							<div class="media-body">
								...
								<p class="quicksand text-normal size-16px">Gameteams Scrum-ledare, huvudansvarlig för databas, samt co-backend programmör.
